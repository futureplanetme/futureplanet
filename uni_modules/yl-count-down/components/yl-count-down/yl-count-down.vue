...
<template>
  <view class="yl-count-down-box" :style="blockStyle">
    ...
    <view class="time-text" :style="textStrStyle" v-if="date && date!=='00'">{{t('Day')}}</view>
    <view class="time-block" :style="timeBlockStyle" v-if="hour && hour!=='00'">{{hour}}</view>
    <view class="time-text" :style="textStrStyle" v-if="hour && hour!=='00'">{{t('Hou')}}</view>
    <view class="time-block" :style="timeBlockStyle" v-if="minute && minute!=='00'">{{minute}}</view>
    <view class="time-text" :style="textStrStyle" v-if="minute && minute!=='00'">{{t('Min')}}</view>
    <view class="time-block" :style="timeBlockStyle">{{second}}</view>
    <view class="time-text" :style="textStrStyle">{{t('Sec')}}</view>
  </view>
</template>
